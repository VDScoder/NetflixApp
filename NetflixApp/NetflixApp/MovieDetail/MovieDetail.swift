...
struct MovieDitail_Previews: PreviewProvider {
    static var previews: some View {
        MovieDitail(movie: exampleMovie1, movieDetailToShow: .constant(nil))
    }
}
...
struct MovieInfoSubheadline: View {
    ...
    var body: some View {
        HStack(spacing: 20) {
            ...
            Text(movie.namberOfSeasonsDisplay)
        }
